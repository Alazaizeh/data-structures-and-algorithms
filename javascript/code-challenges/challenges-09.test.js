...
Write a function named checkValues that takes in an object and a value and returns
...
const checkValues = (obj, value) =>
  Object.values(obj).indexOf(value) > -1 ? true : false;
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const hasChildrenValues = (arr, character) =>
  Object.values(...arr.filter((ele) => ele.name == character)).length > 3;
/* ------------------------------------------------------------------------------------------------
...
const hasChildrenEntries = (arr, character) =>
  Object.entries(...arr.filter((ele) => ele.name == character)).length > 3;
...
const totalCharacters = (arr) =>
  arr.reduce((acc, ele) => acc + Object.keys(ele).length, 1);

/* ------------------------------------------------------------------------------------------------
CHALLENGE 9 - Stretch Goal

Write a function named houseSize that takes in the array of characters and creates 
an object for each house containing the name of the house and the number of members.
...
const houseSize = (arr) => {
  ...
  arr.forEach((element) => {
    let member = 1;
    member += element.spouse !== null ? 1 : 0;
    member += element.children ? element.children.length : 0;
    sizes.push({ house: element.house, members: member });
  });
  return sizes;
};
...
As fans are well aware, "When you play the game of thrones, you win or you die. 
There is no middle ground."

We will assume that Alerie Tyrell is deceased. She missed her daughter's wedding. Twice.

Write a function named houseSurvivors. You may modify your houseSize 
function from challenge 6 to use as the basis of this function.

This function should create an object for each house containing the name of the house
 and the number of members. If the spouse is deceased, do not include him/her in the total
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach((element) => {
    ...
    member += element.spouse !== null ? 1 : 0;
    member += element.children ? element.children.length : 0;
    member -= deceasedSpouses.indexOf(element.spouse) != -1 ? 1 : 0;
    survivors.push({ house: element.house, members: member });
  });
  return survivors;
};
