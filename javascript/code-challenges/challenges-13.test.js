...
Write a function named firstLetters that takes in an array of strings
 and returns an array containing only the first letter of each string.

For example, ['this is great :)', 'wow', 'whyyyyyy :(', ':)))))'] returns ['t', 'w', 'w', ':']
------------------------------------------------------------------------------------------------ */

const firstLetters = (arr) => arr.map((ele) => ele[0]);
...
const findHappiness = (arr) => arr.filter((ele) => ele.includes(":)"));
...
const standardizePhoneNumbers = (arr) =>
  arr.map((ele) => ele.match(/[0-9]*/g).join(""));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5 
...
const allHappy = (arr) =>
  arr.filter((ele) => ele.includes(":)")).length === arr.length;
