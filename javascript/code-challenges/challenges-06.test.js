...
const getNames = (arr) =>
  arr.map((ele) => ele.name.split("").reverse().join(""));
...
Write a function that accepts an array and copies the first element to the end
 of the array. The change should be reflected in the source array that was passed
  in to the function. That is, the function should modify the array 'in place'.
...
const setStatusAsAuthor = (people) => {
  people.map((ele) => (ele["isAuthor"] = true));
};
