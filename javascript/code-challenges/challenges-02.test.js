...
Write a function named addQuestion that,
 given an array of strings, uses map to return a new array containing
...
Write a function named mapTwoToThe that produces the same output as your forLoopTwoToThe
 function from challenge 4 and your forEachTwoToThe function from challenge 5,
...
const charCode = (arr) => {
  // Solution code here...
  let newArr = arr.map((ele) => ele.charCodeAt());
  return newArr;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let newArr = arr.map((ele) => ele.ability.name);
  return newArr;
};
